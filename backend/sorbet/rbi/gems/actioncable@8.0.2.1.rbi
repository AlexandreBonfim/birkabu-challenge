...
class ActionCable::Server::Worker
  ...
  # source://activesupport/8.0.2.1/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#74
  def connection; end

  # source://activesupport/8.0.2.1/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#116
  ...
  class << self
    ...
    # source://activesupport/8.0.2.1/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#49
    def connection; end

    # source://activesupport/8.0.2.1/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#108
    def connection=(obj); end
...
class ActionCable::SubscriptionAdapter::SolidCable < ::ActionCable::SubscriptionAdapter::Base
  # source://solid_cable/3.0.12/lib/action_cable/subscription_adapter/solid_cable.rb#13
  def initialize(*_arg0); end

  # source://actioncable//lib/action_cable/subscription_adapter/channel_prefix.rb#8
  def broadcast(channel, payload); end

  # source://solid_cable/3.0.12/lib/action_cable/subscription_adapter/solid_cable.rb#32
  ...
  # source://solid_cable/3.0.12/lib/action_cable/subscription_adapter/solid_cable.rb#35
  def listener; end
end
